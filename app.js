...
const PROJECTS = [
  ...
  {
    id: "k3",
    name: "K-3 — Техническое описание.txt",
    type: "scp",
    password: "R17T",
    tabs: [
      {
        ...
        html: `
          <div class="banner">
            ...
            This document was created and is managed by the Overwatch Council.
            Unauthorized distribution of this document will result in possible disciplinary action.<br>
            Document access level : 5 Thaumiel [О5:\\C-ms\\K-3]
          </div>
          <div class="warn">
            Если вы здесь по ошибке — немедленно закройте документ и отойдите от устройства.<br>
            ЭМОГ «Альфа-1» уведомлена об открытии данного документа.<br>
      ...
      },
      {
        ...
        html: `
          <div class="banner">
            <b>SCPF | Secure. Contain. Protect.</b><br>
            Managed By the O5 Overwatch [О5:\\C-ms\\K-3]
          </div>
          ${AUTH_SEQ}
        `
      },
      {
        ...
        html: `
          ...
          <h2>Техническое описание и регламент эксплуатации боевого комплекса модели K-3 («Разлом»)</h2>
          <p>Уровень допуска: 5.</p>
          <div class="sec">
            <h3>1. Общее описание</h3>
            <p>Боевой комплекс модели K-3 («Разлом») представляет собой автономный защитный комплекс, превосходящий предшествующие модели боевых комплексов по совокупности боевых, защитных и мобильных характеристик. Комплекс спроектирован для функционирования в условиях активного подавления аномальных свойств и сохраняет работоспособность сквозь якоря реальности, а также сквозь массив пространственной стабилизации Фонтена.</p>
            <p>Основные технические параметры: габаритная высота — 2,71 м; масса в снаряжённом состоянии — 14,7 т; продолжительность автономной работы — до 72 часов. Стоимость единицы изделия — 84 000 000 долларов США (восемьдесят четыре миллиона долларов США). Количество выпущенных моделей — 14 единиц.</p>
            <p>Несмотря на значительную массу корпуса, эффективная мобильность обеспечивается регуляцией руны гравитации, которая компенсирует вес при перемещении и телепортах.</p>
          </div>
          <div class="sec">
            <h3>2. Технические характеристики</h3>
            <h3>2.1. Защитные элементы</h3>
            <p>Конструкция сочетает многослойную композитную броню с рунными вардами. Корпус выдерживает воздействие карманного измерения SCP-106, а также прямое попадание танкового снаряда с дистанции от 3 (трёх) метров. Рунные варды отражают урон и атаки любого рода, включая аномальные воздействия и проклятия.</p>
            <p>Дополнительно: вся электроника комплекса продублирована рунами — сигнал управления невозможно перехватить, заглушить или отследить.</p>
            <h3>2.2. Системы жизнеобеспечения</h3>
            <p>Герметичная капсула пилота с терморегуляцией, регенерацией кислорода (запас 72 часа), фильтрацией токсинов класса «Бета+» и защитой от перегрузок. Автономность обеспечивается связкой тхаум-генератора и стандартного реактора.</p>
            <h3>2.3. Вооружение</h3>
            <p><i>Основное вооружение</i> — структурная руна, выгравированная тауматургами на снайперской винтовке Barrett M82. Руна настроена по принципу транзисторной матрицы (по аналогии с транзисторами она усиливает аспектное излучение). Обладает свойством <b>обязательного попадания в цель</b> и вызывает <b>молекулярный распад</b> поражённого объекта. Дальнобойное.</p>
            <p>Особые патроны сверхтяжёлого класса для Barrett — всего 2 (два) магазина, ввиду сложности производства и высокой стоимости. Ориентировочная стоимость одного магазина спецпатронов — 3 800 000 долларов США (предложение по проекту, подлежит уточнению).</p>
            <p><i>Вторичное вооружение</i> — встроенные пушки и ракетные модули для поражения стандартных целей.</p>
            <h3>2.4. Энергообеспечение</h3>
            <p>Тхаум-генератор (аналог установок Зоны &#9608;&#9608;&#9608;&#9608;&#9608;&#9608;) в связке с обычным реактором. Тхаум-канал питает рунные системы, реактор — силовые приводы и контуры жизнеобеспечения.</p>
            <h3>2.5. Экипаж и управление</h3>
            <p>1 пилот в герметичной капсуле.</p>
            <p>Бортовой ИИ: наводка структурной руны, блокировка лишних действий пилота; при обнаружении внешнего воздействия на комплекс мгновенно выдаёт местоположение источника.</p>
            <p>Удалённый оператор: мониторинг самочувствия группы.</p>
          </div>
          <div class="sec">
            <h3>3. Эксплуатация и обслуживание</h3>
            <p>Боевое применение комплекса возложено на персонал ЭМОГ «Альфа-1» и ЭМОГ «Омега-1». Техническое обслуживание возложено на нескольких утверждённых сотрудников ИТС (инженерно-технической службы).</p>
          </div>
          <div class="sec">
            <h3>4. Порядок доступа и ответственность</h3>
            <p><b>4.1.</b> К ознакомлению допускаются: связанные учёные проекта; персонал ЭМОГ «Альфа-1» и «Омега-1»; советники О5; уполномоченные представители Комитета по Этике.</p>
            <p><b>4.2.</b> Разглашение влечёт дисциплинарную, административную и уголовную ответственность (ст. 283 УК РФ, ФЗ № 5485-1); при утечке аномальной информации — протокол «&#9608;&#9608;&#9608;&#9608;&#9608;&#9608;&#9608;».</p>
          </div>
          <div class="sec">
            <h3>5. Сведения о допуске и персонале</h3>
            <p>Проекту присвоен уровень допуска 5. Кураторы проекта — Lynx (Отдел Морали), Председатель Комитета по Этике, O5-7 и глава ЭМОГ «Омега-1»; тактическое применение согласуется с руководством ЭМОГ «Омега-1».</p>
          </div>
          <div class="sec">
            <h3>6. Требования к пилотированию</h3>
            <p><b>6.1. Подготовка и допуск.</b> Курс подготовки не менее 200 академических часов (симулятор SCP-SIM/K3); проверка совместимости пилота с рунными системами; аттестация с проходным баллом не ниже 91%.</p>
            <p><b>6.2. Порядок продления и медицинский контроль.</b> Допуск продлевается на основании ежемесячной аттестации. Обязательно прохождение медицинского обследования после каждого боевого применения.</p>
            <p><b>6.3. Процедура.</b> Порядок подачи заявки (SCP/K3-APP) засекречен и реализуется по особому регламенту Фонда; раскрытие деталей процедуры запрещено.</p>
            <p><b>6.4. Реестр утверждённых пилотов:</b></p>
            <p>— Глава ЭМОГ «Альфа-1»;<br>— Глава ЭМОГ «Омега-1»;<br>— ряд утверждённых сотрудников ЭМОГ «Альфа-1»;<br>— ряд утверждённых сотрудников ЭМОГ «Омега-1».</p>
          </div>
          <div class="sec">
            <h3>7. Примеры успешного применения</h3>
            <p><b>7.1.</b> При сдерживании объекта класса «Кетер» комплекс обеспечил защиту персонала и нейтрализацию угрозы без привлечения дополнительных сил.</p>
            <p><b>7.2.</b> При инциденте SCP-XXXX — предотвращение появления тауматурга 5 уровня, минимизация потерь, эвакуация материалов.</p>
          </div>
          ${EDIT_WARN}
        `
      }
...
const DB_FOLDER = {
  name:"База данных о", type:"folder", children:[
    { name:"костюмы", type:"folder", children:[
      ...
      { name:"K-3 — Техническое описание.txt", type:"scp", project:"k3" }
    ]}
  ]
};
